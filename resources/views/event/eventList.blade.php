                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="card card-default">
                                    <div class="card-header">List of Events<br>
                                        {{-- <form id="filter-form" action="{{ route('event.listFilter') }}" method="POST" class="d-none"> --}}
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$event->link}}</td>
                                                    <td>
                                                        <button class="btn btn-primary" href=" {{ route('session.store') }}" onclick="event.preventDefault();
                                                     document.getElementById('confirmation').submit();"/>Join {{$id = $event->id}}
                                                            <form id="confirmation" action="{{ route('session.store') }}" method="POST" class="d-none">
                                                                @csrf 
